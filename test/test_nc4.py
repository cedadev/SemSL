...
class test_set3_Methods_posix(unittest.TestCase):
    def setUp(self):
        ...
        #print('IN SETUP TEST SET3 {}'.format(f.variables['var'].ncattrs()))
...
#         subfiles = glob('./testnc_methods/*.nc')
#         subfiles = ['s3://minio/databucket/testnc_methods/'+file.split('/')[-1] for file in subfiles]
#
#         sl_cache._clear_cache()
#         s3 = conn.get()
...
#         f.close()
#         # now check a subfile...
#         f = Dataset('s3://minio/databucket/testnc_methods_var_[0].nc', 'r')
#         vars = f.variables
#         self.assertEqual(len(vars), 5)
#         # Get the dimensions
#         dims = f.dimensions
...
#         f.close()
#         # now check a subfile...
#         f = Dataset('s3://minio/databucket/testnc_methods_renamedvar_[0].nc', 'r')
#         self.assertNotEqual(list(f.variables.keys()), ['T', 'Z', 'Y', 'X', 'var'])
#         self.assertEqual(list(f.variables.keys()), ['T', 'Z', 'Y', 'X', 'renamedvar'])
#         f.close()
#
